...
class ProductProvider {
  ...
  final _productsDB = loadProductsDB();
  ...
  Future<Bundle?> getBundleOfTheWeek() async {
    try {
      return _productsDB.firstWhere((product) => product is Bundle) as Bundle;
    } catch (_) {
      return null;
    }
  }
  ...
  Future<Bundle> getBundleById(String id) async {
    try {
      return _productsDB.firstWhere(
          (product) => product is Bundle && product.id == id) as Bundle;
    } catch (_) {
...
List<Product> productsDatabase = [
  ...
  // Product(
  //   id: const Uuid().v4(),
  //   name: "Simple Chair with Wooden Legs 2",
  //   category: ProductCategory.chairs,
  //   attributesOptions: {
  //     "Color": [
  //       "#000000",
  ...
  // Product(
  //   id: const Uuid().v4(),
  //   name: "Modern Hanging Lighting 2",
  //   category: ProductCategory.lamps,
  //   attributesOptions: {
  //     "Color": [
  //       "#B77740",
  ...
  // Product(
  //   id: const Uuid().v4(),
  //   name: "Bathroom Drawer with Sink 2",
  //   category: ProductCategory.drawer,
  //   attributesOptions: {
  //     "Color": [
  //       "#483831",
  ...
  // Product(
  //   id: const Uuid().v4(),
  //   name: "Modern Bathroom Cabinet 2",
  //   category: ProductCategory.closets,
  //   attributesOptions: {
  //     "Color": [
  //       "#483831",
  ...
  // Product(
  //   id: const Uuid().v4(),
  //   name: "Simple Chair with Wooden Legs 3",
  //   category: ProductCategory.chairs,
  //   attributesOptions: {
  //     "Color": [
  //       "#000000",
  ...
  // Product(
  //   id: const Uuid().v4(),
  //   name: "Modern Hanging Lighting 3",
  //   category: ProductCategory.lamps,
  //   attributesOptions: {
  //     "Color": [
  //       "#B77740",
  ...
  // Product(
  //   id: const Uuid().v4(),
  //   name: "Bathroom Drawer with Sink 3",
  //   category: ProductCategory.drawer,
  //   attributesOptions: {
  //     "Color": [
  //       "#483831",
  ...
  // Product(
  //   id: const Uuid().v4(),
  //   name: "Modern Bathroom Cabinet 3",
  //   category: ProductCategory.closets,
  //   attributesOptions: {
  //     "Color": [
  //       "#483831",
